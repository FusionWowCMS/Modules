							...
							{foreach from=$characters item=realm}
								<table class="table table-striped table-hover table-responsive character-select">
									...
									<tbody>
											...
											{foreach from=$realm.characters item=character}
												<tr class="character-select">
													...
													<td class="align-middle text-end">
														<a href="javascript:void(0);" onClick="CharacterTools.selectCharacter(this, {$realm.realmId}, {$character.guid}, '{$character.name}')">
										...
										{else}
											<tr>
												<td colspan="3" class="text-center py-4">{lang("no_chars", "character_tools")}</td>
											</tr>
										{/if}
									</tbody>
								</table>
	                    ...
	                    <section id="select_tool">
                            ...
                            <div class="select_tools">
                                ...
                                <div class="select_tool">
                                    <div class="tool store_item">
                                        <section class="tool_buttons">
                                            <a href="javascript:void(0)" class="nice_button" onClick="CharacterTools.buy(this, 1, {$config->item('name_change_price')})">
                                                Purchase
                                            </a>
                                        </section>
                                ...
                                <div class="select_tool">
                                    <div class="tool store_item">
                                        <section class="tool_buttons">
                                            <a href="javascript:void(0)" class="nice_button" onClick="CharacterTools.buy(this, 2, {$config->item('race_change_price')})">
                                                Purchase
                                            </a>
                                        </section>
                                ...
                                <div class="select_tool">
                                    <div class="tool store_item">
                                        <section class="tool_buttons">
                                            <a href="javascript:void(0)" class="nice_button" onClick="CharacterTools.buy(this, 3, {$config->item('faction_change_price')})">
                                                Purchase
                                            </a>
                                        </section>
                                ...
                                <div class="select_tool">
                                    <div class="tool store_item">
                                        <section class="tool_buttons">
                                            <a href="javascript:void(0)" class="nice_button" onClick="CharacterTools.buy(this, 4, {$config->item('appearance_change_price')})">
                                                Purchase
                                            </a>
                                        </section>
                                ...
                                <div class="select_tool">
                                    <div class="tool store_item">
                                        <section class="tool_buttons">
                                            <a href="javascript:void(0)" class="nice_button" onClick="CharacterTools.buy(this, 5, {$config->item('revive_change_price')})">
                                                Purchase
                                            </a>
                                        </section>

                                        <img class="item_icon" data-tip="Brings a dead player back to life" src="{$url}application/modules/character_tools/css/images/spell_holy_resurrection.jpg" width="36" height="36" src="" align="absmiddle">
                                ...
                                <div class="select_tool">
                                    <div class="tool store_item">
                                        <section class="tool_buttons">
                                            <a href="javascript:void(0)" class="nice_button" onClick="CharacterTools.buy(this, 6, {$config->item('levelup_change_price')})">
                                                Purchase
                                            </a>
                                        </section>

                                        <img class="item_icon" data-tip="Level Up character" src="{$url}application/modules/character_tools/css/images/spell_holy_innerfire.jpg" width="36" height="36" src="" align="absmiddle">
