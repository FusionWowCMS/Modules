...
<section id="character_tools" dir="dir">
    <section id="select_character">
        <div class="online_realm_button">Charcater Select </div>
                  ...
                  {if {$ban['guid']} ==$character.guid}
                    ...
                    <div class="select_character">
                        ...
                        <div class="character store_item" dir="rtl">
                           ...
                           <br/> </strong><span lang="fa" class="style4"><strong>Date Status <strong></span><strong><span class="style4"> : 
                            ...
                            <span class="style2" lang="fa">day</span>
    ...
    <section id="select_tool" >
        <div class="online_realm_button">Unban</div>
        ...
        <div class="select_tools">
            ...
            <div class="select_tool" >
                <div class="tool store_item" >
                    ...
                    <br />
                        <strong>{if $config->item('unban_price') > 0}<span class="style7"> {$config->item('unban_price')}  DP </span> {else}<span class="style6"> Free </span>{/if}
                        </strong>
                    </div>
                    <div class="clear"></div>
                </div>
